...
ELBOW_EST            = "ELBOW_EST"            # elbow price qty estimation based on weather
LINEAR_A_EST            = "LINEAR_A_EST"            # linear A estimation based on weather
LINEAR_B_EST            = "LINEAR_B_EST"            # linear B estimation based on weather
